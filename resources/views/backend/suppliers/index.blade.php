                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($users as $us)
                                <tr>
                                    ...
                                    <td>{{$us->address}}</td>
                                    <td>
                                        @cannot('delete',Supplier::class)
                                        <a onclick="return confirm('Bạn có muốn xóa ?')" class="btn btn-danger btn-sm" href="{{Route('backend.supplier.destroy',['id'=>$us->id])}}"><i class="fas fa-trash"></i></a>
                                        @endcannot
                                        <a class="btn btn-success btn-sm" href="{{Route('backend.supplier.edit',['id'=>$us->id])}}"><i class="fas fa-edit"></i></a>
